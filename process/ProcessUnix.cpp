...
namespace cpl
{
	...
	void Process::initialise(PipePair& in, PipePair& out, PipePair& err, EnvStrings * strings, const std::string * cwd, int customFlags)
	{
		...
		auto childEnv = strings ? strings->makeEnvironPointer() : environ;
		auto pidf = vfork();
