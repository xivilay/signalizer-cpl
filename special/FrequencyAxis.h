...
**************************************************************************************
	...
	file:FrequencyAxis.h
		...
		Defines a class that calculates linear or logarithmic graph divisions for frequency
		spectrums, based on pixel grid sizes, such that it smaller displays get less
		divisions; conversively for larger displays.

*************************************************************************************/

#ifndef CPL_FREQUENCYAXIS_H
	#define CPL_FREQUENCYAXIS_H
	...
	#define CPL_FREQUENCYAXIS_DO_CHECKS
		...
		namespace special
		{
			...
			public:
				...
				*/
				...
				{
#ifdef CPL_FREQUENCYAXIS_DO_CHECKS
