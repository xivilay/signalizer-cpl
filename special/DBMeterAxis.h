...
#ifndef CPL_DBMETERAXIS_H
#define CPL_DBMETERAXIS_H
...
namespace cpl
{
	namespace special
	{
		...
		public:
			...
			/*
				allows the axis to show linear or logarithmic divisions
			*/
			enum Scaling
			{
				Logarithmic,
			...
			DBMeterAxis(double lDbs = -60, double uDbs = 6, int numMaxDivisions = 10)
