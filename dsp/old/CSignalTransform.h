			...
			//template<typename Scalar>
				...
				public:
					...
					*/
					...
					template<class Vector>
						bool runCustomDFTKernelQSoft(const Vector & data, std::size_t size);

					ScalarTy getLowestQ(std::size_t transformSize);
				...
				private:
					...
					template<size_t channels, class Vector>
					typename std::enable_if<channels == 2, bool>::type
						mqdft_Scalar(const Vector & data, std::size_t size);
					...
					template<size_t channels, class Vector>
					typename std::enable_if<channels == 2, bool>::type
						mqdft_4Vector(const Vector & data, std::size_t size);

					template<size_t channels, class Vector>
					typename std::enable_if<channels == 2, bool>::type
						mqdft_Vector(const Vector & data, std::size_t size);
					...
					template<size_t channels, class Vector>
					typename std::enable_if<channels == 2, bool>::type
						mqdft_8Vector(const Vector & data, std::size_t size);
					...
					template<size_t channels, class Vector>
					typename std::enable_if<channels == 2, bool>::type
						mqdft_FMA(const Vector & data, std::size_t size);
					...
					struct CDFTData
					{
						...
						float omega; // frequency of this oscillator, rads / sec
					};
