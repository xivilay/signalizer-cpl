...
#endif
						case 4:
							return ClassDispatcher::dispatch<isa_traits<Types::v4sf, true>>(std::forward<Args>(args)...);
							break;
						default:
							return ClassDispatcher::dispatch<isa_traits<float, true>>(std::forward<Args>(args)...);
							break;
						}
...
#endif
						case 4:
							return ClassDispatcher::dispatch<isa_traits<Types::v4sf, false>>(std::forward<Args>(args)...);
							break;
						default:
							return ClassDispatcher::dispatch<isa_traits<float, false>>(std::forward<Args>(args)...);
							break;
						}
					}
				}
...
#endif
						case 2:
							return ClassDispatcher::dispatch<isa_traits<Types::v2sd, true>>(std::forward<Args>(args)...);
							break;
						default:
							return ClassDispatcher::dispatch<isa_traits<double, true>>(std::forward<Args>(args)...);
							break;
						}
...
#endif
						case 2:
							return ClassDispatcher::dispatch<isa_traits<Types::v2sd, false>>(std::forward<Args>(args)...);
							break;
						default:
							return ClassDispatcher::dispatch<isa_traits<double, false>>(std::forward<Args>(args)...);
							break;
						}
					}
				}
