		...
		namespace rendering
		{
			...
			*/
			...
			struct LutGammaScale
			{
				...
				#ifdef __MSVC__
					static const double standardGamma = 1.4f;
				#else
					constexpr static const double standardGamma = 1.4f;
				#endif
				...
				LutGammaScale(double gamma = standardGamma)
				{
